...
public class DeactivatingAndReactivatingCampaignTest extends SetUp {
	...
	public void deactivatingCampaignTest() throws Exception {
		...
		AssertJUnit.assertEquals(status,"Active");
		...
		AssertJUnit.assertEquals(campaignName,campaignNameAfterSearch,"Not matched");
		...
		test.log(Status.INFO, "Validating Campaign name after search......");
		AssertJUnit.assertEquals(activeCampaignNameAfterSearch, campaignName, "Not matched");
