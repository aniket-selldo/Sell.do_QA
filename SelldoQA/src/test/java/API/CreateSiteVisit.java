...
public class CreateSiteVisit {
	public static void createSiteVisit(String leadId, String leadID, APIKeys API_Key, APIKeys ClientID, APIKeys SalesID,
			Project ProjectID, String URL) {
	...
	public static void createSiteVisit(String APIKey,String CliendID,String USerID) {
