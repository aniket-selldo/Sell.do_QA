...
public class ReassigningLeadTest extends SetUp {
	...
	public void adminLogin() throws Throwable {
		...
		AssertJUnit.assertEquals(driver.getTitle(), "Sell.Do - Market Smarter. Sell Faster.", "Title Not Matched");
		assertion.assertAll();
	}
	...
	public void reassigningLeadTest() throws Exception {
		...
		SoftAssert assertion = new SoftAssert();
		AssertJUnit.assertEquals(leadId, leadId_after, "Leads are not matching");
		assertion.assertAll();
	}
