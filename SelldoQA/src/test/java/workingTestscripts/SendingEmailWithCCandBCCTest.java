...
public class SendingEmailWithCCandBCCTest extends SetUp {

	final static Logger logger = Logger.getLogger(SendingEmailWithCCandBCCTest.class);
	...
	public void sendingEmailWithCCandBCCTest() throws Exception {
		...
		test = extent.createTest("sendingEmailWithCCandBCCTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Entering Email for CC.......");
		emailPage.enterCCEmail(property.getProperty("ccEmail_sendingEmailWithCCandBCCTest"));

		getExtTest().log(Status.INFO, "Entering Email for BCC.......");
		emailPage.enterBCCEmail(property.getProperty("bccEmail_sendingEmailWithCCandBCCTest"));

		getExtTest().log(Status.INFO, "Entering Subject of Email.......");
		emailPage.enterSubject(property.getProperty("subject_sendingEmailWithCCandBCCTest"));

		getExtTest().log(Status.INFO, "Entering text in email body......");
		emailPage.entertextInBody(property.getProperty("body_sendingEmailWithCCandBCCTest"));
		...
		AssertJUnit.assertEquals(text, "outgoing  |  delivered");
		assertion.assertAll();
