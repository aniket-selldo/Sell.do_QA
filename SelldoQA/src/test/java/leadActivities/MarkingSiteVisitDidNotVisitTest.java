...
public class MarkingSiteVisitDidNotVisitTest extends BaseTest {
	...
	public void markingSiteVisitDidNotVisitTest() throws Exception {
		...
		Assert.assertEquals(getSuccessMSG(), "Site visit for Visit scheduled successfully.","Site Visit no shedule succesfully");
		
		//Thread.sleep(15000);

		extentTest.get().log(Status.INFO, "Selecting Mark Did Not Visit from Action Bar.......");
		...
		//Thread.sleep(15000);
		Assert.assertEquals(getSuccessMSG(), "Site visit for Visit updated successfully.","Status not change succesfully");
