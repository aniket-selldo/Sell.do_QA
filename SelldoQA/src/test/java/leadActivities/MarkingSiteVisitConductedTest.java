...
public class MarkingSiteVisitConductedTest extends BaseTest {
	...
	public void markingSiteVisitConductedTest() throws Exception {
		...
		// extentTest.get().log(Status.INFO, "Selecting Mark As Conducted from Action
		// Bar.......");
		leadProfilePage.selectMarkAsConducted();

		// extentTest.get().log(Status.INFO, "Selecting date on which Site visit was
		// conducted.......");
		siteVisitPage.sitevisitConductedOnDate2();

		// extentTest.get().log(Status.INFO, "Writing some notes for conducted site
		// visit.......");
		...
		// extentTest.get().log(Status.INFO, "Clicking on Mark as Conducted
		// button.......");
