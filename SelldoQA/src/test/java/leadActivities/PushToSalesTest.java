...
public class PushToSalesTest extends BaseTest {
	...
	public void pushingLeadTest_ForwardingOff() throws Exception {
		...
		// getExtTest().log(Status.INFO,"Signing in as a sales user to which lead is to
		// be pushed.......");
		...
		// getExtTest().log(Status.INFO, "Signing in as a Presales user from which lead
		// is to be pushed......");
		...
		// getExtTest().log(Status.INFO, "Selecting Team of user to which lead is to be
		// pushed......");
		pushToSalesPage.selectTeam("Test Master 01");

		// Thread.sleep(3000);

		// getExtTest().log(Status.INFO, "Selecting User to which lead is to be
		// pushed......");
		...
		// getExtTest().log(Status.INFO, "Validating that count is not same after lead
		// push.......");
