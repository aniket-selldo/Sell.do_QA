...
public class SendingBrochure_WithoutTemplateTest extends SetUp {

	WebDriverWait wait;

	final static Logger logger = Logger.getLogger(SendingBrochure_WithoutTemplateTest.class);
	...
	public void appLogin() throws Exception {
		...
		login.login(
				property.getProperty("name") + "+"
						+ property.getProperty("user_email_SendingBrochure_WithoutTemplateTest"),
	...
	public void sendingBrochure_WithoutTemplateTest() throws Exception {
		...
		test = extent.createTest("sendingBrochure_WithoutTemplateTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Select brochure from dropdown.......");
		emailPage.selectBrochureOption();

		BrochurePage brochurePage = new BrochurePage(driver);

		String subjectText = property.getProperty("subject_sendingBrochure_WithoutTemplateTest");
		...
		brochurePage.writingSomeTextInBody(property.getProperty("email_sendingBrochure_WithoutTemplateTest"));

		getExtTest().log(Status.INFO, "Clicking on Send Brochure Button.......");
		...
		getExtTest().log(Status.INFO, "Verifying that Brochure is sent.......");
