...
public class ChangingStage_ProspectToUnqualifiedTest extends BaseTest {

	@Test

	public void changingStage_ProspectToUnqualifiedTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Changing stage from Prospect to Unqualified.......");

		leadProfilePage.changing_Stage("Unqualified");


		extentTest.get().log(Status.INFO, "Selecting reason for Unqualified.......");
		...
		extentTest.get().log(Status.INFO, "Verifying stage changed from Prospect to Unqualified.......");
		...
		Assert.assertEquals(textDropdownObj, "Unqualified", "Not matched");
