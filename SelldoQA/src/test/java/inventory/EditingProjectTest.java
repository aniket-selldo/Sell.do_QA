...
public class EditingProjectTest extends SetUp {
	...
	public void editingProjectTest() throws Exception {
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='All Projects']/following::label[1]")).getText(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[@for='project_address_attributes_address1']"))
		...
		test.log(Status.INFO, "Verifying Address link.......");
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[@class='add_spec btn btn-outline-primary']"))
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[@title='New']")).getAttribute("innerHTML").trim(),
