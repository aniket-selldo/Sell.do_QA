...
public class EditingUnitTest extends SetUp {
	...
	public void editingUnitTest() throws Exception {
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//button[@id='dropdownMenu1']")).getText().trim(), "Add cost",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[@title='Preview']")).getAttribute("innerHTML").trim(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[@for='unit_configuration_developer']"))
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='Add Another Unit']"))
