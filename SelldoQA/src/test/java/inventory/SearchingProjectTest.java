...
public class SearchingProjectTest extends SetUp {

	final static Logger logger = Logger.getLogger(SearchingProjectTest.class);
	...
	public void searchingProjectTest() throws Exception {
		...
		test = extent.createTest("searchingProjectTest");
		setExtentTest(test);
		...
		String projectName = property.getProperty("project_name_searchingProjectTest");
