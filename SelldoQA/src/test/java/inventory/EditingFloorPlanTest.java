...
public class EditingFloorPlanTest extends SetUp {
	...
	public void editingFloorPlanTest() throws Exception {
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='All Floor Plans']/following::label[1]")).getText(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//div[text()='Areas']")).getText().trim(), "Areas",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[text()='Category']")).getText().trim(), "CATEGORY",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//input[@name='image[]']")).getText().trim(), "",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='Add Brochure']")).getText().trim(), "Add Brochure",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='New Region']")).getText().trim(), "New Region",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[text()='Project cost template']")).getText().trim(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='New Unit']")).getText().trim(), "New Unit",
				"Not matched");
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[@for='project_unit_developer']")).getText().trim(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='New Floor Plan']")).getText().trim(),
