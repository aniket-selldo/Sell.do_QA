...
public class EditingProjectTowerTest extends SetUp {
	...
	public void editingProjectTowerTest() throws Exception {
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[@for='project_tower_total_builtup_area']"))
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[text()='New Schedule']")).getAttribute("innerHTML").trim(),
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[@href='/client/unit_configurations/new']"))
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//a[@href='/client/project_towers/new']"))
		...
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//label[@for='project_tower_tower_name']"))
