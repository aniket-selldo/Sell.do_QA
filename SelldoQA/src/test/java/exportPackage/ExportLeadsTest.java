...
public class ExportLeadsTest extends BaseTest {
	...
	public void exportLeadsTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Clicking on Export Leads tab.......");
		...
		extentTest.get().log(Status.INFO, "Selecting Export type as Leads.......");
		...
		extentTest.get().log(Status.INFO, "Validating that the latest export is made for Leads.......");
