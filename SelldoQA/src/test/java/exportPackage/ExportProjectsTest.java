...
public class ExportProjectsTest extends BaseTest {
	...
	public void exportProjectsTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Clicking on Export Projects tab.......");
		...
		extentTest.get().log(Status.INFO, "Selecting Export type as Project.......");
		...
		extentTest.get().log(Status.INFO, "Validating that the latest export is made for Projects.......");
		// Assert.assertEquals(Project, "Projects - Export 1", "Not matched");
		Assert.assertTrue(driver.findElements(By.cssSelector("#export_type")).get(0).getText()
				.contains("Projects - Export"), "Not matched");
