...
public class ExportFollowupsTest extends BaseTest {
	...
	public void exportFollowupsTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Clicking on Export Followups tab.......");
		...
		extentTest.get().log(Status.INFO, "Selecting Export type as Followups.......");
		...
		extentTest.get().log(Status.INFO, "Validating that the latest export is made for Followups.......");
