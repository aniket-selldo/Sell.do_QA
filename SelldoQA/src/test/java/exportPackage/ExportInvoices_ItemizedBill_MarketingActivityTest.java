...
public class ExportInvoices_ItemizedBill_MarketingActivityTest extends BaseTest {
	...
	public void exportInvoices_ItemizedBill_MarketingActivityTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Selecting Marketing Activity from Type dropdown.......");
		...
		extentTest.get().log(Status.INFO, "Selecting Export type as Itemised Bill(Marketing Activity).......");
		...
		extentTest.get().log(Status.INFO,
				"Validating that the latest export is made for Itemized Bill Marketings.......");
		// Assert.assertEquals(itemisedBill_MarketingActivity, "Itemized Bill Marketings
		// - Export 1", "Not matched");
