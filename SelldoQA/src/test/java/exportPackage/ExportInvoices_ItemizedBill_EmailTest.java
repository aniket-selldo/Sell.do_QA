...
public class ExportInvoices_ItemizedBill_EmailTest extends BaseTest {
	...
	public void exportInvoices_ItemizedBill_EmailTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Selecting Email from Type dropdown.......");
		...
		extentTest.get().log(Status.INFO, "Selecting Export type as Itemised  Bill(Email).......");
		...
		extentTest.get().log(Status.INFO, "Validating that the latest export is made for  Itemized Bill Emails.......");
