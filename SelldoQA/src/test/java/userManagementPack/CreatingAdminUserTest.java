...
public class CreatingAdminUserTest extends SetUp {

	final static Logger logger = Logger.getLogger(CreatingAdminUserTest.class);
	...
	public void creatingAdminUserTest() throws Exception {
		...
		test = extent.createTest("Creating Admin User Test");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Admin from role dropdown.......");
		...
		manageUsersPage.searchUser(phone_SearchObj);
