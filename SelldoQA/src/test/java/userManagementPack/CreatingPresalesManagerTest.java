...
public class CreatingPresalesManagerTest extends BaseTest {
	...
	public void creatingPresalesManagerTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Selecting Presales department from dropdown.......");
		newUserFormPage.selectDepartment_Presales();

		extentTest.get().log(Status.INFO, "Selecting Manager role from dropdown.......");
		newUserFormPage.selectRole_Manager();

		Thread.sleep(4000);

		extentTest.get().log(Status.INFO, "Selecting Team from dropdown.......");
		newUserFormPage.selectTeam2();
