...
public class CreatingPresalesManagerTest extends SetUp {

	final static Logger logger = Logger.getLogger(CreatingPresalesManagerTest.class);

	// Description: Creating a new Presales Manager
	...
	public void creatingPresalesManagerTest() throws Exception {

		test = extent.createTest("creatingPresalesManagerTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Presales department from dropdown.......");
		newUserFormPage.selectDepartment_Presales();

		getExtTest().log(Status.INFO, "Selecting Manager role from dropdown.......");
