...
public class CreatingPostsalesManagerTest extends BaseTest {
	...
	public void creatingPostsalesManagerTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Selecting Postsales from department dropdown.......");
		newUserFormPage.selectDepartment_PostSales();

		Thread.sleep(2000);

		extentTest.get().log(Status.INFO, "Selecting Manager from role dropdown.......");
