...
public class CreatingPostsalesManagerTest extends SetUp {

	final static Logger logger = Logger.getLogger(CreatingPostsalesManagerTest.class);

	// Description: Creating a new Postsales Manager
	...
	public void creatingPostsalesManagerTest() throws Exception {

		test = extent.createTest("creatingPostsalesManagerTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Postsales from department dropdown.......");
		newUserFormPage.selectDepartment_PostSales();

		Thread.sleep(2000);

		getExtTest().log(Status.INFO, "Selecting Manager from role dropdown.......");
		newUserFormPage.selectRole_Manager();

		Thread.sleep(3000);

		getExtTest().log(Status.INFO, "Selecting Team from dropdown.......");
		newUserFormPage.selectTeamForManager();
