...
public class CreatingSalesUserTest extends BaseTest {
	...
	public void creatingSalesUserTest() throws Exception {
		...
		com.selldo.POM.adminPages.ManageUsersPage manageUsersPage = new ManageUsersPage(driver);
		...
		extentTest.get().log(Status.INFO, "Selecting Sales department.......");
		newUserFormPage.selectDepartment_Sales();

		extentTest.get().log(Status.INFO, "Selecting Sales role.......");
