...
public class CreatingSalesManagerTest extends SetUp {

	final static Logger logger = Logger.getLogger(CreatingSalesManagerTest.class);

	// Description: Creating a new Sales Manager
	...
	public void creatingSalesManagerTest() throws Exception {
		...
		test = extent.createTest("creatingSalesManagerTest");
		setExtentTest(test);
		...
		getExtTest().log(Status.INFO, "Selecting Sales department from dropdown.......");
