...
public class Result {
	...
	private String default_for_client_id;
	private String default_pre_sales_for_client_id;
	...
	private ArrayList<String> pre_sales_project_ids;
	...
	private String custom_datetime_date;
	private String custom_datetime_time;
	...
	public ArrayList<String> getCampaign_ids() {
		return campaign_ids;
	}

	public void setCampaign_ids(ArrayList<String> campaign_ids) {
	...
	public String getDefault_for_client_id() {
		return default_for_client_id;
	}

	public void setDefault_for_client_id(String default_for_client_id) {
		this.default_for_client_id = default_for_client_id;
	}

	public String getDefault_pre_sales_for_client_id() {
		return default_pre_sales_for_client_id;
	}

	public void setDefault_pre_sales_for_client_id(String default_pre_sales_for_client_id) {
	...
	public ArrayList<String> getPre_sales_project_ids() {
		return pre_sales_project_ids;
	}

	public void setPre_sales_project_ids(ArrayList<String> pre_sales_project_ids) {
	...
	public String getCustom_datetime_date() {
		return custom_datetime_date;
	}

	public void setCustom_datetime_date(String custom_datetime_date) {
		this.custom_datetime_date = custom_datetime_date;
	}

	public String getCustom_datetime_time() {
		return custom_datetime_time;
	}

	public void setCustom_datetime_time(String custom_datetime_time) {
		this.custom_datetime_time = custom_datetime_time;
	}
}
