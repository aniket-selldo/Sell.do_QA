...
public class Root {
	...
	private boolean billing_disabled;
	...
	private Ms365CalendarDetails ms365_calendar_details;
	...
	private VoipProviderDetails voip_provider_details;
	...
	public boolean isBilling_disabled() {
		return billing_disabled;
	}

	public void setBilling_disabled(boolean billing_disabled) {
	...
	public Ms365CalendarDetails getMs365_calendar_details() {
		return ms365_calendar_details;
	}

	public void setMs365_calendar_details(Ms365CalendarDetails ms365_calendar_details) {
	...
	public VoipProviderDetails getVoip_provider_details() {
		return voip_provider_details;
	}

	public void setVoip_provider_details(VoipProviderDetails voip_provider_details) {
		this.voip_provider_details = voip_provider_details;
	}
