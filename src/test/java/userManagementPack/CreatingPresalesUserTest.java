...
public class CreatingPresalesUserTest extends BaseTest {
	...
	public void creatingPresalesUserTest() throws Exception {
		...
		extentTest.get().log(Status.INFO, "Selecting Presales department.......");
		newUserFormPage.selectDepartment_Presales();

		extentTest.get().log(Status.INFO, "Selecting Presales role.......");
