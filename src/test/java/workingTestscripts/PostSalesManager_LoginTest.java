...
public class PostSalesManager_LoginTest extends SetUp{
	...
	@Test
	public void postsalesManagerLoginTest() throws Exception, EmailException {
		...
		test = extent.createTest("postsalesManagerLoginTest");
		setExtentTest(test);
		LoginPage login = new LoginPage(driver);
		
		getExtTest().log(Status.INFO, "Logging in to postsales Manager user......");
		login.login(property.getProperty("name") + "+" + property.getProperty("postsalesManager_email"),
